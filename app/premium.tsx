    ...
    <ScrollView style={styles.body}>
      ...
      {/*Diamond*/}
       <View style={styles.row}>
        <Link href="/Premium/Diamond/FloorA" asChild>
          <Pressable style={styles.card} >
            <Image source={require("../assets/images/premium1.png")} style={styles.image} />
            <Text style={styles.name}>Diamond Hall</Text>
            <View style={styles.box}>
                <Text style={styles.boxText}>Premium</Text>
            </View>
        ...
        <View style={styles.subText}>
            ...
            <Text style={{fontWeight:'bold'}}>5 students/room</Text>
        </View>
        ...
        <View style={styles.subTextAv} >
            ...
            {/*Queen Esther*/}
        <Link href="/Premium/Queen_Esther/FloorA" asChild>
          <Pressable style={styles.card}>
            <Image source={require("../assets/images/premium1.png")} style={styles.image} />
            <Text style={styles.name}>Queen Esther Hall</Text>
            <View style={styles.box}>
                <Text style={styles.boxText}>Premium</Text>
            </View>
        ...
        {/*Ruby*/}
        <Link href="/Premium/Ruby/FloorA" asChild>  
          <Pressable style={styles.card}>
            <Image source={require("../assets/images/premium1.png")} style={styles.image} />
            <Text style={styles.name}>Ruby Hall</Text>
            <View style={styles.box}>
                <Text style={styles.boxText}>Premium</Text>
            </View>
             <View > 
