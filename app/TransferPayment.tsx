      ...
      {/*Payment methods*/}
       ...
       <View style={styles.container1}>
          <View style={styles.subText}>
                  <Text style={styles.label1}>Bank Transfer Details </Text>
                  <Text style={styles.value}><Ionicons name="time-outline" size={20} color="red" /> 29:56(countdown)</Text>
          </View>
          <View style={styles.yellowBox}>
            <Text style={styles.yellowBoxText}>Note: Please compplete the transfer within 30 minutes. Your booking will be automatically cancelled if payement is not received.</Text>
          </View>

          <View style={styles.container}>
            <View style={{flexDirection:'column'}}>
            <Text>Account Number</Text>
            <Text style={{fontWeight:'bold'}}>1234567890</Text></View>
            <Text style={{color:'#2321c4'}}><Ionicons name="copy" size={20} color="#2321c4" />Copy</Text>
          </View>
                           ...
                           <Link href="/classic" asChild>
                              ...
                              <Pressable
                                style={{...styles.BottomtoggleButton, ...styles.BottomtoggleInActive}}>
                                 <Text><Ionicons name="checkmark-circle-outline" size={16} color="white" /> I have transferred</Text>
                              </Pressable>
                              </Link>
                   </View>
